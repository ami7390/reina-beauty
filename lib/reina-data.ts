...
export type Service = {
  id: number;
  category: "locks" | "tresses" | "soins" | "visage" | "teinture" | "henne" | "onglerie";
  title: string;
  subtitle: string;
  description: string;
  duration: string;
...
export const services: readonly Service[] = [
  ...
  { id: 2, category: "locks", title: "Micro Locks — Resserrage & Entretien", subtitle: "Suivi des repousses", description: "Resserrage des repousses, contrôle de la grille et entretien pour conserver des Micro Locks nettes et régulières.", duration: "2h – 3h", price: "Tarif sur devis", image: "/images/coiffures/locks/micro-locks-client.webp" },
  { id: 17, category: "locks", title: "Micro Locks", subtitle: "Fines locks régulières et légères", description: "Création de micro locks fines et harmonieuses, adaptée à la densité, à la longueur et au rendu souhaité.", duration: "Selon la densité", price: "Tarif sur devis", image: "/images/coiffures/locks/micro-locks-client.webp", highlight: "Fin & élégant" },
  { id: 19, category: "locks", title: "Dreadlocks", subtitle: "Création & entretien", description: "Création et entretien de dreadlocks selon la texture, la longueur et le style recherché.", duration: "Selon la longueur", price: "Tarif sur devis", image: "/images/coiffures/locks/dreadlocks-client.webp" },
  { id: 20, category: "locks", title: "Sister Locks", subtitle: "Locks fines et structurées", description: "Une technique de locks fines, structurées et régulières, proposée après diagnostic de la chevelure.", duration: "Selon la longueur et la densité", price: "Tarif sur devis", image: "/images/coiffures/locks/sister-locks-client.webp" },

  { id: 21, category: "locks", title: "Vanilles", subtitle: "Coiffure protectrice torsadée", description: "Des vanilles régulières et souples, réalisées selon la longueur, la densité et le rendu souhaité.", duration: "Selon la longueur", price: "Tarif sur devis", image: "/images/coiffures/twists/reina-vanilles.webp", highlight: "Protectrice" },
  { id: 22, category: "locks", title: "Twist", subtitle: "Torsades naturelles", description: "Des twists travaillés avec soin pour un résultat net, léger et facile à porter au quotidien.", duration: "Selon la densité", price: "Tarif sur devis", image: "/images/coiffures/twists/reina-micro-twist.webp" },
  { id: 23, category: "locks", title: "Micro Twist", subtitle: "Fines torsades longue tenue", description: "Des micro twists fins et réguliers pour un rendu élégant, léger et polyvalent.", duration: "Selon la longueur et la densité", price: "Tarif sur devis", image: "/images/coiffures/twists/reina-micro-twist-client.webp", highlight: "Fin & léger" },
