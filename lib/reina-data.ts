...
export const services: readonly Service[] = [
  ...
  { id: 2, category: "locks", title: "Micro Locks — Resserrage & Entretien", subtitle: "Suivi des repousses", description: "Resserrage des repousses, contrôle de la grille et entretien pour conserver des Micro Locks nettes et régulières.", duration: "2h – 3h", price: "Tarif sur devis", image: "/images/coiffures/locks/reina-installation-locks-tiktok.webp" },
  { id: 17, category: "locks", title: "Starter Locks", subtitle: "Démarrage de locks naturelles", description: "Création d’un départ de locks adapté à votre texture, votre densité et au rendu final souhaité.", duration: "Selon la densité", price: "Tarif sur devis", image: "/images/coiffures/locks/reina-installation-locks-tiktok.webp" },
  { id: 19, category: "locks", title: "Retwist & Entretien Locks", subtitle: "Repousses et finitions", description: "Entretien des racines, remise en forme et finitions pour préserver une apparence propre et harmonieuse.", duration: "Selon la repousse", price: "Tarif sur devis", image: "/images/coiffures/locks/reina-installation-locks-tiktok.webp" },
