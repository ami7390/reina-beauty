  ...
  return (
    <main className="min-h-screen bg-luxury-bg pb-28">
      <section className="relative isolate overflow-hidden border-b border-luxury-line px-5 py-20 lg:px-8">
        <ManagedImage src="/images/soins/baume/reina-baume-preparation-tiktok.webp" alt="Boutique et soins Reina Beauty" className="absolute inset-0 -z-20 h-full w-full object-cover" />
        ...
        <div className="mx-auto max-w-7xl">
          <div className="max-w-2xl">
            ...
            <h1 className="mt-6 font-serif text-5xl font-bold leading-tight text-luxury-deep sm:text-6xl">Vos soins, votre panier, <span className="text-luxury-wine">une commande simple</span></h1>
