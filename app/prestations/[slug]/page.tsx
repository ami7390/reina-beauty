...
const heroVideos: Partial<Record<FamilySlug, { src: string; poster?: string; label: string }>> = {
  ...
  tresses: { src: "/videos/heroes/hero-tresses.mp4", poster: "/images/coiffures/nattes/reina-nattes-artistiques.webp", label: "Tressage afro en salon" },
  ...
  henne: { src: "/videos/heroes/hero-henne.mp4", label: "Henné artistique" },
};
